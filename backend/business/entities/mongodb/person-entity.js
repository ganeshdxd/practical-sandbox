...
const model = require("../../../helpers/constants").MONGODB.INSTANCES.PERSON
const schema = require("../../../domains/mongodb/schemas").SCHEMAS.PERSON

class PersonEntity extends BaseEntityMongoDb {
  constructor() {
    super(model, schema)
  }
